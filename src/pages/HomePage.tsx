import { ArrowUpRight, Gauge, Leaf, Target, TrendingDown } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <PageTitle
        ...
        title="Panel de Inteligencia de Carbono"
      ...
      <section className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
        <ChartCard title="Huella por alcance" description="Lectura ejecutiva del inventario GEI consolidado.">
